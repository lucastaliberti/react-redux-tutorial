...
describe('Voting', () => {
  it('renders a pair of buttons', () => {
    ...
    expect(buttons[1].textContent).to.equal('26 Days Later')
  })

  it('invokes a callback when a button is cliked', () => {
    let votedWith
  ...
  it('adds a label to voted entry', () => {
    const component = renderIntoDocument(
      <Voting pair={['Trainspotting','26 Days Later']}
  ...
  it('renders a pure component', () => {
    const pair = ['Trainspotting','26 Days Later']
